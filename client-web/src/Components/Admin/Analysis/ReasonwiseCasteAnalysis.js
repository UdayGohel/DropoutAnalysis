...
const ReasonwiseCasteAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `${ip}/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&type1=Reasons&type2=Caste&standard=${standard}`,
      requestOptions
    )
