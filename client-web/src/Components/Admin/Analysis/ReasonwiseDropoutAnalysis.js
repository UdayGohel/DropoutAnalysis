...
const ReasonwiseDropoutAnalysis = ({
  ...
  useEffect(() => {
    ...
    fetch(
      `${ip}/FilterStudentinGroupByTwo?state=${selectedState}&district=${selectedDistrict}&city=${selectedCity}&taluka=${selectedTaluka}&school&type1=Reasons&type2=null&standard=`,
      requestOptions
    )
